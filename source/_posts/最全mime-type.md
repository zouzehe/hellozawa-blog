...
#
# $ Id: .mime.types,v 1.7 2004/03/07 11:18:44 roland Exp roland $
#

application/x-gzip-dvi              dvi.gz
application/x-gzip-postscript           ps.gz
...
application/pro_eng             prt PRT
application/remote-printing
application/rtf                 rtf
application/set                 set SET
appliaction/sla                 stl STL
application/slate
application/solids              SOL
application/STEP                stp STP step STEP
application/vda                 vda VDA
application/wita
...
text/english
text/html                   html htm
text/plain                  asc txt c cc h hh C f90
text/richtext                   rtx
